                    ...
                    <form action="<?php echo base_url()?>changepin/updatepin" method="POST" id="changepinform" class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" id="old_pin" name="old_pin"  class="form-control validate[required] col-md-7 col-xs-12" value="">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="password" id="new_pin" name="new_pin" class="form-control validate[required] col-md-7 col-xs-12" value="">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12">Confirm Pin <span class="required">*</span></label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="confirm_pin" class="form-control validate[required] col-md-7 col-xs-12" type="password" name="confirm_pin" value="">
                        </div>
                      </div>
