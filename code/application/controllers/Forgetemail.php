     ...
     public function verifyemail()
        {
            ...
            if(count($userid)==1)
            {
                ...
                {
                    if($this->sendforgetmail($tomail,$otp))
                    {
        ...
        public function sendforgetmail($tomail,$otp)
        {
...
<div style="margin-bottom:10px;">Your wallet password has been update successfully. Your updated password is given below. Please login and change first. <br><br> <div>
